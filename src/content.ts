...
export const content = {
  ...
  nav: {
    nameOfTabs: [
      { name: "Home", url: "/" },
      { name: "Statistics & Achievements", url: "/statistics-achievements" },
      { name: "Scientific Corner", url: "/scientific-corner" },
    ],
  },
  Home: {
    topPart: {
    ...
    SingleCard: {
      OurMessage: {
        title: "Our Message",
        desc: "We seek to enable young people to acquire programming and technology skills information through an inspiring educational environment that enhances creative thinking. And innovation.",
        icon: Mail,
      },
      OurVision: {
        title: "Our Vision",
        desc: "We aspire to be a leading programming club that empowers students to excel in technology and innovation, fostering a community of skilled programmers who contribute positively to society.",
        icon: Eye,
      },
      OurGoals: {
        title: "Our Goals",
        desc: "Our goal is to create a vibrant community of programmers who are passionate about technology and innovation. We aim to provide opportunities for learning, collaboration, and personal growth, empowering our members to become skilled professionals in the field of programming.",
        icon: Users,
      },
    },
    ProgramUnit: {
    ...
    MembersSection: [
      ...
      },
      {
        ...
        boldTitle: "Heads",
        members: [
          { name: "Joory Aldossary", role: "(Head of Publications & Marketing Unit)" },
      ...
      },
      {
        ...
        members: [
          ...
          { name: "Raghad Jathmi", role: "(Vice Head of Events & Organization Unit)" },
        ],
      },
      {
      ...
      },
      {
        ...
        boldTitle: "Heads",
        members: [
          { name: "Saud Almousa", role: "(Head of Public Relation Unit)" },
          { name: "Raghad Alkhaldi", role: "(Vice head of Public Relation Unit)" },
        ],
      },
      {
        title: "Coordinators",
    ...
    dataOfEvents: [
      {
        title: "Can you find the bugs in the bank?",
        describe: "lets have a fun time finding errors",
        buttonText: "Join Us!",
      },
      {
        title: "We just have started a new year!",
        describe: "take a look into our new structure, members, and more....",
